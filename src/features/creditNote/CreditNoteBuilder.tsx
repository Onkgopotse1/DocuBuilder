      ...
      <div className="max-w-2xl mx-auto pt-28 px-6 space-y-10">
        ...
        <div>
          ...
          <div className="hidden sm:grid grid-cols-12 gap-3 mb-2">
            <span className="col-span-6 text-[10px] font-bold uppercase tracking-widest text-slate-300">Description</span>
            <span className="col-span-2 text-[10px] font-bold uppercase tracking-widest text-slate-300">Qty</span>
            <span className="col-span-2 text-[10px] font-bold uppercase tracking-widest text-slate-300">Unit Price</span>
            <span className="col-span-2 text-[10px] font-bold uppercase tracking-widest text-slate-300">Amount</span>
          </div>

          {creditNote.items.map((item, idx) => (
            <div key={idx} className="group grid grid-cols-12 gap-3 items-end py-3 border-b border-slate-100">
              ...
              <div className="col-span-3 sm:col-span-2 flex items-end gap-1">
                <div className="flex-1">
                  ...
                  <input
                    ...
                    value={item.amount}
                    readOnly
                    className={`${inputCls} text-right bg-slate-50`}
                  />
                </div>
                <button
                  onClick={() => removeItem(idx)}
                  className="mb-1.5 w-7 h-7 rounded-lg text-slate-200 hover:text-rose-400 hover:bg-rose-50 transition-all flex items-center justify-center sm:opacity-0 sm:group-hover:opacity-100"
                >
          ...
          <button
            onClick={addItem}
            className="flex items-center gap-2 text-sm font-bold text-rose-500 hover:text-rose-600 transition-colors mt-4"
          >
