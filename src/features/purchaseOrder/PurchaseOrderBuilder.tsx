...
export default function PurchaseOrderBuilder() {
  ...
  const updateItem = (index: number, field: keyof PurchaseOrderItem, value: any) => {
    setDocument((prev) => {
      ...
      // Auto‑recalculate total when quantity or unitPrice changes
      ...
      <div className="max-w-3xl mx-auto pt-24 px-4 space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="bg-white rounded-2xl border-2 border-blue-100 p-5">
            ...
            <div className="space-y-3">
              <div>
                <label className="text-[10px] font-black uppercase tracking-wider text-slate-400 block mb-1">Company Name</label>
                <input
                  type="text"
                  value={po.buyerCompany}
                  onChange={(e) => updateField('buyerCompany', e.target.value)}
                  placeholder="Your business"
                  className="w-full px-3 py-2 bg-[#f0f4ff] border border-blue-100 rounded-lg text-slate-700 text-sm placeholder:text-slate-300 focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 transition-all"
                />
              </div>
              <div>
              ...
              <div>
                <label className="text-[10px] font-black uppercase tracking-wider text-slate-400 block mb-1">Billing Address</label>
                <input
                  type="text"
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-5">
            ...
            <div className="space-y-3">
              <div>
                <label className="text-[10px] font-black uppercase tracking-wider text-slate-400 block mb-1">Vendor Name</label>
                <input
                  type="text"
                  value={po.vendorName}
                  onChange={(e) => updateField('vendorName', e.target.value)}
                  placeholder="Supplier company"
                  className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-slate-700 text-sm placeholder:text-slate-300 focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 transition-all"
                />
              </div>
              <div>
                <label className="text-[10px] font-black uppercase tracking-wider text-slate-400 block mb-1">Contact Person</label>
              ...
              <div>
                <label className="text-[10px] font-black uppercase tracking-wider text-slate-400 block mb-1">Vendor Address</label>
                <input
                  type="text"
        ...
        <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
          ...
          <div className="p-6 space-y-3">
            ...
            {po.items.map((item, idx) => (
              <div key={idx} className="group grid grid-cols-12 gap-3 items-center">
                <div className="col-span-12 sm:col-span-5">
                  <label className="sm:hidden text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1 block">Item {idx + 1}</label>
                  <input
                    type="text"
                ...
                <div className="col-span-4 sm:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-[#f0f4ff] border border-blue-100 rounded-lg text-slate-700 text-sm placeholder:text-slate-300 focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 transition-all text-center"
                  />
                </div>
                <div className="col-span-4 sm:col-span-2">
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 bg-[#f0f4ff] border border-blue-100 rounded-lg text-slate-600 text-sm focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 transition-all"
                  >
                ...
                <div className="col-span-3 sm:col-span-2 flex items-center gap-1">
                  <div className="flex-1">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-[#f0f4ff] border border-blue-100 rounded-lg text-slate-700 text-sm placeholder:text-slate-300 focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 transition-all text-right"
                    />
                  </div>
                  <button
                    onClick={() => removeItem(idx)}
                    className="w-7 h-7 rounded-lg text-slate-200 hover:text-red-400 hover:bg-red-50 transition-all flex items-center justify-center sm:opacity-0 sm:group-hover:opacity-100 flex-shrink-0"
                  >
            ...
            <button
              onClick={addItem}
              className="flex items-center gap-2 text-sm font-bold text-blue-600 hover:text-blue-700 transition-colors mt-1"
            >
          ...
          <div className="border-t-2 border-blue-100 bg-[#f0f4ff] px-6 py-5">
            <div className="max-w-xs ml-auto space-y-2.5">
              ...
              <div className="flex justify-between text-sm items-center gap-3">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="w-14 px-2 py-1 bg-white border border-blue-200 rounded-lg text-sm text-center focus:outline-none focus:border-blue-400 transition-all"
                  />
                  <span className="font-semibold text-slate-700 w-16 text-right">R{vatAmount.toFixed(2)}</span>
                </div>
              </div>
              <div className="pt-3 border-t-2 border-blue-200 flex justify-between">
                ...
                <span className="font-black text-blue-600 text-xl">R{total.toFixed(2)}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="bg-white rounded-2xl border border-slate-200 p-5">
            ...
            {po.paymentTerms === 'Custom' && (
              <div className="mt-3">
                <label className="text-[10px] font-black uppercase tracking-wider text-slate-400 block mb-1">Custom terms</label>
                <input
                  type="text"
                  value={po.customTerms || ''}
                  onChange={(e) => updateField('customTerms', e.target.value)}
                  placeholder="e.g. 60 days net"
                  className="w-full px-3 py-2 bg-[#f0f4ff] border border-blue-100 rounded-lg text-slate-700 text-sm placeholder:text-slate-300 focus:outline-none focus:border-blue-400 transition-all"
                />
              </div>
            )}
          </div>
