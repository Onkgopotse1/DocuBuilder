      ...
      <div className="max-w-3xl mx-auto pt-24 px-4 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm focus:ring-4 focus:ring-violet-500/10 focus:border-violet-500 transition-all outline-none bg-slate-50/40 text-slate-700"
                >
        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
          ...
          <div className="p-6 space-y-3">
              ...
              <div key={idx} className="grid grid-cols-12 gap-2 items-center group">
                ...
                <div className="col-span-1 flex justify-center">
                  <button
                    ...
                    className="w-8 h-8 rounded-lg text-slate-300 hover:text-red-400 hover:bg-red-50 transition-colors flex items-center justify-center opacity-0 group-hover:opacity-100"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              onClick={addItem}
              className="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-violet-600 bg-violet-50 hover:bg-violet-100 rounded-xl transition-all border border-violet-100 mt-2"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="max-w-xs ml-auto space-y-2.5">
              ...
              <div className="flex justify-between text-sm items-center gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  />
                  <span className="font-semibold text-slate-800 w-16 text-right">R {tax.toFixed(2)}</span>
                </div>
              </div>
              <div className="pt-3 border-t border-slate-200 flex justify-between items-center">
                <span className="font-extrabold text-slate-800">Total</span>
                <span className="font-extrabold text-violet-700 text-lg">R {total.toFixed(2)}</span>
              </div>
            </div>
          </div>
        </div>
